...
fprintf('DEMO KPC - lrd fit\n')
fprintf('Press any key to continue...\n')
pause
demo_kpcfit_bcaug89

fprintf('DEMO KPC - lrd fit (3rd order)\n')
fprintf('Press any key to continue...\n')
pause
demo_kpcfit_bcaug89_thirdord

clear
fprintf('DEMO KPC - lrd fit, positive and negative acf - 8 states \n')
fprintf('Press any key to continue...\n')
pause
demo_kpcfit_dec_pkt_1_udp8

clear
fprintf('DEMO KPC - lrd fit, positive and negative acf - 16 states \n')
fprintf('Press any key to continue...\n')
pause
