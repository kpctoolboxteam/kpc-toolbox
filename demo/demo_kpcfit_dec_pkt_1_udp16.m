...
%%
[MAP,fac,fbc,kpcMAPs] = kpcfit_auto(trace,'OnlyAC',1,'MaxRunsAC',1,'MaxIterAC',50,'AnimateAC',1,'NumStates',16);
%%
subplot(1,2,1)
plot(acf(S,1:100),'k-'); hold on; plot(1:100,trace.ACFull(1:100),'r-');
...
subplot(1,2,2)
loglog(acf(S,1:max(trace.ACLags)),'k-'); hold on; plot(trace.ACLags,trace.AC,'r-');
